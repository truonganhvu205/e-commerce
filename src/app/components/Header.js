...
const Header = () => {
    ...
    return (
        <div className='flex items-center min-w-screen px-8 py-2 bg-sky-700 text-white'>
            <Link href={'/'} className='text-4xl mx-4'>
                <h1>E-Commerce</h1>
            </Link>

            <form action="" onSubmit={handleSubmit} className='mx-4 grow flex items-center'>
                <input
                    type="text"
                    placeholder='Search...'
                    className='rounded-l border-l border-y border-slate-900 grow py-1 px-4'
                />
                <button
